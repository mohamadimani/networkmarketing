...
//   ===   require view  ===
    function admin_view($url = '', $data = [], $header = '', $footer = '')
    {
        ...
        $this->model("headers");
        $count_com = $this->model->show_new_comments();
        $employ = $this->model->show_new_employ();
        $resume = $this->model->show_new_resume();
        $site_options = $this->model->get_options();
        $bout_us = $this->model->get_bout_us();
        $all_access = $this->model->user_all_access();
