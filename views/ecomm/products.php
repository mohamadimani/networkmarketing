    ...
    <div class="section">
        ...
        <div class="content" style="width: 100%;">
            ...
            <div class="headline tertiary">
                <h4 style="margin: 0;"> محصولات پیدا شد</h4>
                <!-- VIEW SELECTORS -->
            </div>
            ...
            <div class="product-showcase" style="width: 100%;">
                ...
                <div class="product-list grid column3-4-wrap" style="width: 100%;">
                    ...
                    if (!empty($products)) {
                            ...
                            <div class="product-item column">
                                ...
                                <div class="product-preview-actions">
                                    ...
                                    <figure class="product-preview-image" style="text-align: center">
                                        <img src="<?= SITE_URL ?>public/product/<?= $product["id"] ?>/gallery/l/<?= $product["image"] ?>"
                                             alt="<?= $product["seo"] ?>" style="width: auto;">
                                    </figure>
                                ...
                                <div class="product-info">
                                    ...
                                    <a href="<?= SITE_URL ?>ecomm/category">
                                        <p class="category primary"><?= $product["title"] ?></p>
                                    </a>
                        ...
                        <p style="padding: 100px 0;font-size: 15px;direction: rtl">در این دسته بندی هنوز محصولی افزوده
                            نشده ... </p>
                    <?php } ?>
                </div>
                <!-- /PRODUCT LIST -->
