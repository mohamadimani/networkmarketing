<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">ویرایش دسته بندی گالری</h4>
                ...
                <div class="col-sm-12 col-md-8">
                    <div class="card-box">
                        ...
                        if (!empty($category)) {
                            ?>
                            <?php
                            if (!empty($_SESSION["edit_gallery_category"]) and $_SESSION["edit_gallery_category"] == "success") {
                                ?>
                            ...
                            <?php }
                            if (!empty($_SESSION["edit_gallery_category"]) and $_SESSION["edit_gallery_category"] == "danger") {
                                ?>
                            ...
                            <?php }
                            if (!empty($_SESSION["edit_gallery_category"]) and $_SESSION["edit_gallery_category"] == "empty") {
                                ?>
                            ...
                            <?php }
                            unset($_SESSION["edit_gallery_category"]);
                            ?>
                            <h4 style="margin: 10px 0 30px 0;"><b> افزودن دسته جدید </b></h4>
                            <form action="<?= SITE_URL ?>admin_gallery_category/update_category/<?= $category["id"] ?>"
                                  method="post"
