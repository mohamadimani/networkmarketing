    ...
    <div class="col-sm-8 col-xs-8 col-sm-push-3 col-xs-push-3">
        <div class="card-box">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h4 class="m-t-0 header-title pull-left"><b> مدیریت ثبت نام های اتاق فکر</b></h4>
        ...
        <div class="card-box">
            ...
            <div class="table-responsive">
                <table class="table table-hover mails m-0 table table-actions-bar">
                    ...
                    foreach ($idea_employ as $employ) { ?>
                        <tr class="active">
                            <td><?= $employ['name'] ?></td>
                            <td><?= $employ['mobile'] ?></td>
                            <td><?= $employ['comment'] ?></td>
                            <td><?= convert_date($employ['creat_date']) ?></td>
                            <td class="status"><?php if ($employ['status'] == "NEW") {
                                    echo "جدید";
                                } else if ($employ['status'] == "SEEN") {
                                    echo "دیده شده";
                                } ?></td>
                            <?php if ($employ['status'] == "NEW") { ?>
                                <td class="active"><span class="btn btn-success fa fa-check"
                                                         onclick="seen_user(<?= $employ["id"] ?>,this)"></span></td>
                            <?php } else if ($employ['status'] == "SEEN") { ?>
                                <td class="active"><span class=" fa fa-eye"></span></td>
                            <?php } ?>
