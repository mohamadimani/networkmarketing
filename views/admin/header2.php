...
$model = new model();
$count_com = $model->show_new_comments();
$employ = $model->show_new_employ();
$resume = $model->show_new_resume();
$site_options = $model->get_options();
$bout_us = $model->get_bout_us();
$all_access = $model->user_all_access();
