<?php
$audio = $data['audio'];
$get_audio_category = $data['get_audio_category'];
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">فایل های صوتی</h4>
            ...
            <div class="row port m-t-20 m-b-20">
                <div class="portfolioContainer ">
                    <div class="col-sm-12 col-xs-12  col-md-8 webdesign illustrator">
                        <form action="<?= SITE_URL ?>admin_audio/upload_audio" method="post"
                            ...
                            <div class="gal-detail thumb float_right">
                                ...
                                <div class="form-group m-t-20 float_left  col-xs-12  col-md-8">
                                    <input type="file" name="audio_img" class="filestyle up_img float_right m-l-20"
                                           data-size="sm">
                    ...
                    foreach ($audio as $row) { ?>
                        <div class="col-sm-6 col-lg-4 m-t-20 col-md-4 webdesign illustrator">
                            <div class="gal-detail box ">
                                ...
                                <audio controls style="width: 320px!important;">
                                    <source src="<?= SITE_URL ?>public/audio/<?= $row['img_name'] ?>" type="audio/mp3">
                                ...
                                <div>
                                    ...
                                    <div class="">
                                        <select onchange="set_category(this,<?= $row["id"] ?>)" name="category" id="m1"
                                            ...
                                            <?php
                                            foreach ($get_audio_category as $category) {
    ...
    <script>
        ...
        function set_category(item, img_id) {
            var cat_id = $(item).val();
            var url = "<?= SITE_URL ?>admin_audio/update_category";
        ...
        function set_check(item, id) {
            ...
            var url = "<?= SITE_URL ?>admin_audio/save_change";
        ...
        function set_link(item, id) {
            ...
            var url = "<?= SITE_URL ?>admin_audio/set_link";
        ...
        function set_alt(item, id) {
            var item_value = $(item).val();
            var url = "<?= SITE_URL ?>admin_audio/set_alt";
            var data = {"value": item_value, "id": id};
            $.post(url, data, function (msg) {
                if (msg == true) {
        ...
        function delete_img(id, item) {
            var url = "<?= SITE_URL ?>admin_audio/delete_img";
            var data = {"id": id};
            $.post(url, data, function (msg) {
                if (msg == true) {
