<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">مدیریت دسته بندی فایل صوتی </h4>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-8">
                    <div class="card-box">
                        ...
                        <form action="<?= SITE_URL ?>admin_audio/save_category" method="post"
                        ...
                        <table class="table table-hover mails m-0 table table-actions-bar m-t-20">
                            ...
                            foreach ($category as $item) {
                                ...
                                <tr class="active">
                                    ...
                                    <td>
                                        <!-- ==========Edit ====== -->
                                        <a href="<?= SITE_URL ?>admin_audio/edit_category/<?= $item['id'] ?>"
                                           title="ویرایش"
                                           class="table-action-btn ">
    ...
    <script>
        ...
        function delete_category(id, item) {
            var url = "<?= SITE_URL ?>admin_audio/category_delete";
            var data = {'id': id};
            $.post(url, data, function (msg) {
                if (msg == true) {
