<?php
$video = $data['video'];
$get_video_category = $data['get_video_category'];
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">ویدئوها</h4>
            ...
            <div class="row port m-t-20 m-b-20">
                <div class="portfolioContainer ">
                    <div class="col-sm-12 col-xs-12  col-md-6 webdesign illustrator">
                        <form action="<?= SITE_URL ?>admin_video/upload_video" method="post"
                              enctype="multipart/form-data">
                            <div class="gal-detail thumb float_right">
                                <label class="control-label label2 col-xs-12 float_right  col-md-3 "> آپلود ویدئو
                                    جدید</label>
                                <div class="form-group m-t-20 float_left  col-xs-12  col-md-8">
                                    <input type="file" name="video_img" class="filestyle up_img float_right m-l-20"
                                           data-size="sm">
                        ...
                        <div class="col-sm-6 col-lg-3 m-t-20 col-md-4 webdesign illustrator">
                            <div class="gal-detail box ">
                                ...
                                <video width="230" height="240" controls>
                                    <source src="<?= SITE_URL ?>public/video/<?= $row['img_name'] ?>" type="video/mp4">
                                ...
                                <div>
                                    ...
                                    <div class="">
                                        <select onchange="set_category(this,<?= $row["id"] ?>)" name="category" id="m1"
                                            ...
                                            <?php
                                            foreach ($get_video_category as $category) {
    ...
    <script>
        ...
        function set_category(item, img_id) {
            var cat_id = $(item).val();
            var url = "<?= SITE_URL ?>admin_video/update_category";
        ...
        function set_check(item, id) {
            ...
            var url = "<?= SITE_URL ?>admin_video/save_change";
        ...
        function set_link(item, id) {
            ...
            var url = "<?= SITE_URL ?>admin_video/set_link";
        ...
        function set_alt(item, id) {
            var item_value = $(item).val();
            var url = "<?= SITE_URL ?>admin_video/set_alt";
            var data = {"value": item_value, "id": id};
            $.post(url, data, function (msg) {
                if (msg == true) {
        ...
        function delete_img(id, item) {
            var url = "<?= SITE_URL ?>admin_video/delete_img";
            var data = {"id": id};
            $.post(url, data, function (msg) {
                if (msg == true) {
