<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">ویرایش دسته بندی ویدئوها</h4>
                ...
                <div class="col-sm-12 col-md-8">
                    <div class="card-box">
                        ...
                        if (!empty($category)) {
                            ?>
                            <?php
                            if (!empty($_SESSION["edit_video_category"]) and $_SESSION["edit_video_category"] == "success") {
                                ?>
                            ...
                            <?php }
                            if (!empty($_SESSION["edit_video_category"]) and $_SESSION["edit_video_category"] == "danger") {
                                ?>
                            ...
                            <?php }
                            if (!empty($_SESSION["edit_video_category"]) and $_SESSION["edit_video_category"] == "empty") {
                                ?>
                            ...
                            <?php }
                            unset($_SESSION["edit_video_category"]);
                            ?>
                            <h4 style="margin: 10px 0 30px 0;"><b> افزودن دسته جدید </b></h4>
                            <form action="<?= SITE_URL ?>admin_video/update_category_title/<?= $category["id"] ?>"
                                  method="post"
    ...
    <script>
        ...
        function active_user(id, status, item) {
            var url = "<?= SITE_URL ?>admin_video/category_status_change";
