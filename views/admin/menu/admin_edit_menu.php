<div class="content-page">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-8">
                    <div class="card-box">
                        ...
                        <form action="<?= SITE_URL ?>admin_panel/update_menu/<?= $menu["id"] ?>" method="post"
                              enctype="multipart/form-data">
                            <div class="m-t-20">
                                <h5><b>نام </b></h5>
                                <input required type="text" name="name" class="form-control"
                                       id="thresholdconfig" value="<?= @$menu["name"] ?>"/>
                            </div>
                            <div class="m-t-20">
                                <h5><b>نام انگلیسی</b></h5>
                                <input required type="text" name="EN_name" class="form-control"
                                       id="thresholdconfig" value="<?= @$menu["EN_name"] ?>"/>
                            </div>
                            <div class="m-t-20">
                                <h5><b>لینک</b></h5>
                                <input required type="text" name="link" class="form-control"
                                       id="thresholdconfig" value="<?= @$menu["link"] ?>"/>
                            </div>

                            <div class="m-t-20">
                                <h5><b> ایکون (تصویر)</b></h5>
                                <input required type="text" name="icon" class="form-control"
                                       id="thresholdconfig" value="<?= @$menu["icon"] ?>"/>
                            </div>

                            <div class="checkbox checkbox-custom">
                                <input id="checkbox11" type="checkbox" name="status" <?php if (@$menu["icon"]) {
                                    echo "checked";
                                } ?> >
    ...
    <script>
        ...
        function active_user(id, status, item) {
            var url = "<?= SITE_URL ?>admin_menu/menu_status";
